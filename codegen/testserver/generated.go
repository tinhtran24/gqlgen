...
`},
	&ast.Source{Name: "weird_type_cases.graphql", Input: `# regression test for https://github.com/tinhtran24/gqlgen/issues/583
...
func (ec *executionContext) _Subscription_updated(ctx context.Context, field graphql.CollectedField) func() graphql.Marshaler {
	...
	// FIXME: subscriptions are missing request middleware stack https://github.com/tinhtran24/gqlgen/issues/259
	//          and Tracer stack
	rctx := ctx
